...
switch char(X.Config.Forecasting.Analysis.Type)
    case 'Individual'
        X.Config.Forecasting.Analysis.Assets = 6; % the selected assets
    case 'Assetclass'
        X.Config.Forecasting.Analysis.Assets = 1:numel(X.Config.ExcelLoad.AssetList); % the selected assets

end
X.Config.Forecasting.Analysis.StartDate = {'2015-12-10'}; % startdate
X.Config.Forecasting.Analysis.EndDate = {'2020-01-13'}; % enddate
X.Config.Forecasting.Analysis.WindowSize = 50; % the windowsize 
...
X.Config.Forecasting.Model.RF.Lag = 4; % possible lag parameters
